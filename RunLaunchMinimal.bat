...
REM BUTR libs + ModReady + one settings mod). If this reaches the main menu
...
powershell -NoProfile -ExecutionPolicy Bypass -NoExit -Command ".\scripts\Launch-Standalone.ps1 -ModulesOverride @('Native','SandBoxCore','Sandbox','StoryMode','Bannerlord.Harmony','Bannerlord.ButterLib','Bannerlord.UIExtenderEx','Bannerlord.MBOptionScreen','ModReady','AIInfluence')"
