...
// Management Group.
//
// ModReady.ButterLib SubModule entry. Installs BEW finalizers, builds the
...
public class ButterLibSubModule : MBSubModuleBase
{
    ...
    protected override void OnSubModuleLoad()
    {
        ...
        try
        {
            ...
            OptionsKeybindCategoryPatch.Install(new global::HarmonyLib.Harmony("modready.butterlib.hotkeyoptions"));
    ...
    protected override void OnBeforeInitialModuleScreenSetAsRoot()
    {
        ...
        // in module load order and ModReady loads FIRST (it is the consumers'
    ...
    private static void QuarantineXorberaxShoulderCamera()
    {
        ...
        int removed = 0;
        var harmony = new HarmonyLib.Harmony("ModReady.ButterLib.Quarantine.XorberaxShoulderCamera");
