// ModReady.Foundation -- AssemblyLoaderDependencyShim
//
...
//     compiled against `Bannerlord.ButterLib v2.10.3.0` but ModReady's
...
public static class AssemblyLoaderDependencyShim
{
    ...
    private const string HarmonyId = "modready.foundation.assemblyloaderdepshim";
