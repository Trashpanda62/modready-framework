// ModReady.Foundation -- CulpritFinder
//
...
// declaring type is NOT engine / framework / ModReady infrastructure.
...
public static class CulpritFinder
{
    ...
    private static readonly string[] _enginePrefixes =
    {
        ...
        "ModReady", "Bannerlord.Harmony", "Bannerlord.UIExtenderEx",
    ...
    /// framework, or ModReady' own infrastructure -- i.e. NOT a consumer
