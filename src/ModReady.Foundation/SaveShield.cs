...
// lifecycle hook (ModReadyHarmonySubModule).
...
{
    private const string Tag = "ModReady.SaveShield";
    private const string HarmonyId = "ModReady.Foundation.SaveShield";
    ...
    // first install so stale files don't sit in the user's ModReady folder.
    ...
    // non-engine, non-ModReady frame so mod authors get a one-line answer.
