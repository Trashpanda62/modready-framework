// ModReady.Foundation -- DiagLog
//
// Thin static facade over RuntimeLog. Other ModReady assemblies prefer
// to call this via reflection so they don't have to take a hard build-
// time reference on ModReady.Foundation.dll. The reflection pattern is:
//
//   var foundation = AppDomain.CurrentDomain.GetAssemblies()
//       .FirstOrDefault(a => a.GetName().Name == "ModReady.Foundation");
//   var diag = foundation?.GetType("ModReady.Foundation.DiagLog");
...
public static class DiagLog
{
    ...
    /// logs every Slot/Next/Prev/Selected/ModReady SetPropertyValue (~60 lines
