...
//   2. modready-compat-warnings.log next to runtime.log -- a small,
//      dedicated file users can paste into a bug report without hunting.
//
// Usage from inside ModReady assemblies that reference Foundation:
//
...
public static class CompatWarn
{
    ...
    private const string FileName = "modready-compat-warnings.log";
