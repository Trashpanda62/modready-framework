// ModReady.MCM -- MusicOptionsPatch
//
...
// @ModReadyMusicVisible (reference-equality to the captured AudioOptions category)
...
//   {ModReadyMusicRows}    -> one MusicRowVM per context (enable/mode/volume/count)
//   @ModReadyMusicVisible  -> hides the whole section unless this is the audio category
//
...
// in ModReadyHarmonySubModule.cs (plus $IncludeMusicPicker in scripts\Build-Phase1.ps1).
...
internal sealed class MusicOptionsPatch : PrefabExtensionInsertPatch
{
    ...
    public string XmlContent =>
        "<ListPanel Id=\"ModReadyMusicSection\" IsVisible=\"@ModReadyMusicVisible\" WidthSizePolicy=\"StretchToParent\" HeightSizePolicy=\"CoverChildren\" HorizontalAlignment=\"Center\" VerticalAlignment=\"Top\" MarginTop=\"24\" MarginBottom=\"40\" StackLayout.LayoutMethod=\"VerticalTopToBottom\">\n"
        + "  <Children>\n"
        ...
        // ---- per-context rows ----
        + "    <ListPanel DataSource=\"{ModReadyMusicRows}\" WidthSizePolicy=\"CoverChildren\" HeightSizePolicy=\"CoverChildren\" HorizontalAlignment=\"Center\" StackLayout.LayoutMethod=\"VerticalTopToBottom\">\n"
        + "      <ItemTemplate>\n"
