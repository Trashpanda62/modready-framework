// ModReady.MCM -- MusicOptionsMixin
//
...
// AudioOptions instance isn't captured yet. ModReadyMusicVisible / ModReadyMusicRows
...
internal sealed class MusicCategoryMixin : BaseViewModelMixin<ViewModel>
{
    ...
    public override void OnRefresh()
    {
        try
        {
            ViewModel.NotifyPropertyChanged(nameof(ModReadyMusicVisible));
            ViewModel.NotifyPropertyChanged(nameof(ModReadyMusicRows));
        }
        catch { }
    }
    ...
    [DataSourceProperty]
    public bool ModReadyMusicVisible
    {
        get
        {
    ...
    [DataSourceProperty]
    public MBBindingList<MusicRowVM> ModReadyMusicRows
    {
