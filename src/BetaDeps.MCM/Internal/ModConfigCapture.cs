...
// `betadeps-capture-modconfig.flag` file is present in Modules\BetaDeps\, this
...
//   2. Selects the injected "Mod Configuration" tab (BetaDepsModConfigPage) by
...
//   4. Writes betadeps-capture-complete.flag, deletes the trigger flag, and
...
internal static class ModConfigCapture
{
    ...
    private const string CaptureFlagName = "betadeps-capture-modconfig.flag";
    private const string DoneFlagName    = "betadeps-capture-complete.flag";
    ...
    private const string SelfTestFlagName = "betadeps-run-selftest.flag";
    ...
    private static void SelectModConfigTab()
    {
        ...
        var toggle = FindWidgetById(root, "BetaDepsModConfigTabToggle", 0);
        if (toggle != null)
        {
            D("found BetaDepsModConfigTabToggle");
        ...
        if (tabControl != null)
        {
            ...
            TrySet(tabControl, "TabName", "BetaDepsModConfigPage");
        }
        ...
        var modList = FindWidgetById(root, "BetaDepsModListPanel", 0);
