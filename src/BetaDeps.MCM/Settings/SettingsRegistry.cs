...
public static class SettingsRegistry
{
    ...
    public static void EagerLoadModuleAssemblies()
    {
        try
        {
            ...
            // MCMv5.dll lives in Modules\BetaDeps\bin\Win64_Shipping_Client\
            ...
            var betaDepsModule = Path.GetDirectoryName(betaDepsBin);       // BetaDeps
            var modulesRoot    = Path.GetDirectoryName(betaDepsModule);    // Modules
