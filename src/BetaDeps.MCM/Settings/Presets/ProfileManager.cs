...
//
// ProfileManager -- the MCM-integration half of BetaDeps v2.0 framework
// primitive #4 (whole-loadout settings profiles). The engine-free file work
// lives in BetaDeps.Framework.SettingsProfileStore (Foundation); this class
...
//
// Lives in MCMv5.dll but is exposed under the BetaDeps.Framework namespace so
// the entire v2.0 framework surface is one `using BetaDeps.Framework;` for
// consumers, regardless of which BetaDeps assembly a given primitive ships in.
...
namespace BetaDeps.Framework
{
    ...
    {
        private const string Tag = "BetaDeps.ProfileManager";
