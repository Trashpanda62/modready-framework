// ModReady.UIExtenderEx -- SubModule entry point.
//
...
/// in Modules\ModReady\SubModule.xml.
/// </summary>
public class ModReadyUIExtenderExSubModule : MBSubModuleBase
{
    private const string Tag = "ModReady.UIExtenderEx";

    private static readonly global::HarmonyLib.Harmony _harmony =
        new("modready.uiextenderex");
    ...
    protected override void OnSubModuleLoad()
    {
        ...
        try
        {
            var asmName = typeof(ModReadyUIExtenderExSubModule).Assembly.GetName();
