BetaDeps — Bring Your Own (BYO) Music
=====================================

Drop your own audio files into the folders below and BetaDeps plays them in
...
play. BetaDeps regenerates its PSAI soundtrack from this tree every launch.
...
-----
  ...
  * You'll see a "PC" subfolder appear next to your files after first launch —
    that's BetaDeps staging a link the game's audio loader needs. Leave it.
  * Check Modules\BetaDeps\runtime.log for lines tagged PsaiRedirect /
