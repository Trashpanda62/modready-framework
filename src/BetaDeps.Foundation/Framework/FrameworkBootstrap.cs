...
// Harmony patches. Called from BetaDepsHarmonySubModule's late lifecycle hooks
...
//     drops a `perf-profiler.flag` file in Modules\BetaDeps\ (same flag-file
...
using BetaDeps.Foundation;   // DiagLog, RuntimeLog

namespace BetaDeps.Framework
{
    public static class FrameworkBootstrap
    {
        private const string Tag = "BetaDeps.Framework";
