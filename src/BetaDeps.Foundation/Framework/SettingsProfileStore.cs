...
//
// SettingsProfileStore -- the file engine behind BetaDeps v2.0 framework
...
namespace BetaDeps.Framework
{
    ...
    {
        private const string Tag = "BetaDeps.SettingsProfileStore";
        ...
        private void WriteManifest(string dir, List<string> ids)
        {
            try
            {
                ...
                sb.AppendLine("# BetaDeps settings profile");
