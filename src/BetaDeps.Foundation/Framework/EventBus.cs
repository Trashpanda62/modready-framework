...
//
// EventBus -- BetaDeps v2.0 framework primitive #1: type-safe + named-channel
...
//          EventBus.Subscribe("BetaDeps.WarDeclared", payload => ...);
//          EventBus.Publish("BetaDeps.WarDeclared", someObject);
//
...
namespace BetaDeps.Framework
{
    ...
    {
        private const string Tag = "BetaDeps.EventBus";
