// BetaDeps.Foundation -- RuntimeLog
//
// Append-only diagnostic log written to Modules\BetaDeps\runtime.log
// during gameplay. Other BetaDeps assemblies call into this via
...
//   * Log location MUST anchor on Modules\BetaDeps\ regardless of which
...
//     .Location points to the alias folder, NOT to Modules\BetaDeps\.
//     We resolve the canonical BetaDeps folder by walking up the tree
//     looking for a sibling "BetaDeps" folder under Modules\.
//
...
public static class RuntimeLog
{
    ...
    private static string ResolvePath()
    {
        ...
        return System.IO.Path.Combine(Environment.CurrentDirectory, "betadeps-runtime.log");
    }
