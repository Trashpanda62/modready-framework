// ModReady.Harmony -- BetaSigSafePatches
//
...
internal static class BetaSigSafePatches
{
    ...
    private const string HarmonyId = "modready.harmony.sigsafe";
    ...
    {
        var missionType = ModReady.Foundation.ReflectionUtils.ResolveTypeByFullName("TaleWorlds.MountAndBlade.Mission");
        if (missionType == null)
        {
    ...
    {
        var widgetType = ModReady.Foundation.ReflectionUtils.ResolveTypeByFullName("TaleWorlds.GauntletUI.PrefabSystem.WidgetFactory")
                      ?? ModReady.Foundation.ReflectionUtils.ResolveTypeByFullName("TaleWorlds.GauntletUI.UIContext");
        if (widgetType == null)
        {
