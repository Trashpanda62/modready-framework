// ModReady clean-room re-implementation of Bannerlord.BUTR.Shared.Helpers.ApplicationVersionHelper.
...
public static class ApplicationVersionHelper
{
    ...
    /// ModReady.Foundation.VersionProbe already relies on as its Plan A) is
