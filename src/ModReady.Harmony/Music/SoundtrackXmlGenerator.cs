// ModReady.Harmony -- SoundtrackXmlGenerator
//
// Turns the active BYO pools (MusicConfig) into the runtime PSAI project at
// Modules\ModReady\Music\soundtrack.xml, then leaves it for
...
//   final clip path = Modules\ModReady\Music\<dir>\PC\<name>.ogg
...
public static class SoundtrackXmlGenerator
{
    ...
    public static SoundtrackGenResult Generate(MusicConfig cfg)
    {
        ...
        try
        {
            ...
            sb.Append("<!-- GENERATED AT RUNTIME by ModReady SoundtrackXmlGenerator. Do not edit; ")
    ...
    private static void AppendTheme(StringBuilder sb, MusicContext ctx, string segmentsXml)
    {
        ...
        sb.Append("    <Theme>\n");
        sb.Append("      <Name>").Append(Esc($"ModReady_{ctx}")).Append("</Name>\n");
