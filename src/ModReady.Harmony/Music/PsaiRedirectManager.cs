// ModReady.Harmony -- PsaiRedirectManager
//
...
//      PsaiCore.LoadSoundtrackFromProjectFile(["Native", "NavalDLC"?, "ModReady"])
...
public static class PsaiRedirectManager
{
    ...
    private const string HarmonyId = "modready.music.psai";
    ...
    public static void Pump()
    {
        ...
        try
        {
            ...
            if (!_patchInstalled)
            {
                ...
                // Crucial: inject "ModReady" into EVERY LoadSoundtrackFromProjectFile
    ...
    /// Ensures "ModReady" (and "NavalDLC" when installed) is in the module list
