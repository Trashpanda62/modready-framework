...
public sealed class MusicConfig
{
    ...
    /// <summary>Absolute path to the deployed ModReady module directory, e.g.
    /// ...\Modules\ModReady. Empty string if it could not be resolved.</summary>
    public string ModuleDir { get; private set; } = "";

    /// <summary>Absolute path to ...\Modules\ModReady\Music\BYO.</summary>
    ...
    public static MusicConfig Load()
    {
        ...
        try
        {
            ...
            {
                DiagLog.Log(Tag, "could not resolve ModReady module directory; BYO music disabled this session.");
                cfg.InitEmpty();
                return cfg;
            }
    ...
    /// <summary>
    /// Resolve ...\Modules\ModReady from this assembly's location. The DLL
    /// lives at ...\Modules\ModReady\bin\Win64_Shipping_Client\ModReady.Harmony.dll,
    ...
    private static string ResolveModuleDir()
    {
        ...
        var moduleDir = Path.GetDirectoryName(modReadyBin);     // ModReady
    ...
    //   Documents\Mount and Blade II Bannerlord\Configs\ModReady\byo-music.cfg
    ...
    private static string? ResolveSettingsPath()
    {
        try
        {
            ...
            return Path.Combine(docs, "Mount and Blade II Bannerlord", "Configs", "ModReady", SettingsFileName);
        }
        catch { return null; }
    }
    ...
    public void SaveSettings()
    {
        try
        {
            ...
            sb.Append("# ModReady BYO music settings -- auto-saved from Options > Sound. Delete to reset.\n");
