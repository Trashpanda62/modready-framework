@echo off
REM ===========================================================================
REM  Update ALL FIVE ModReady Steam Workshop items to the current dist build.
REM
...
REM
REM    ModReady      3741426797   UIExtenderEx  3741428357   MCM  3741428715
...
echo [1/5] ModReady (main)...
start "Upload ModReady"      /wait "%UPLOADER%" "%WS%\WorkshopUpdate-ModReady.xml"
